...
{ 
  ...
  //
  fSumEAbs = /*fSum2EAbs=*/fSumEGap  =0; // fSum2EGap1 = 0.;
...
void RunAction::fillPerEvent(G4double EAbs, G4double EGap//, G4double EGap1
...
// fSumEGap1 /=NbOfEvents;
  ...
  G4cout
     << "\n--------------------End of Run------------------------------\n"
     << "\n Energy in Absorber : " << G4BestUnit(fSumEAbs,"Energy")
     //<< " +- "                          << G4BestUnit(rmsEAbs,"Energy")  
     << "\n Energy in Gap      : " << G4BestUnit(fSumEGap,"Energy")
